...
public class TestClorus {
    ...
    public void testAttack() {
        ...
        Plip p = new Plip(2);
        c.attack(p);
        assertEquals(5.00, c.energy(), 0.01);
    }

    @Test
    public void testChoose() {

        // No empty adjacent spaces; stay, even if there are Plips nearby.
        ...
        p = new Clorus(1.2);
        HashMap<Direction, Occupant> emptyPlip = new HashMap<Direction, Occupant>();
        emptyPlip.put(Direction.TOP, new Empty());
        emptyPlip.put(Direction.BOTTOM, new Plip());
        emptyPlip.put(Direction.LEFT, new Impassible());
        emptyPlip.put(Direction.RIGHT, new Impassible());
        actual = p.chooseAction(emptyPlip);
